...
$sql->execute([
  $_SESSION['customer']['id'],$_REQUEST['id'],$_REQUEST['card_name'],$_REQUEST['card_type'],$_REQUEST['card_no'],
  ...
  echo '<p class=purchase><a href="purchase-confirm">購入手続きを続ける</a><p></div>';
}else{
   echo '<h2>カード情報登録</h2>';
  echo '<div class=box>';
